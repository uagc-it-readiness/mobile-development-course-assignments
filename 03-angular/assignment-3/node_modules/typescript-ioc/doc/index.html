...
<span class="hljs-keyword">class</span> PersonDAO {
  ...
  restProxy: PersonRestProxy;
				...
				<pre><code class="lang-typescript"><span class="hljs-meta">@AutoWired</span>
<span class="hljs-keyword">class</span> PersonService {
  <span class="hljs-keyword">private</span> personDAO: PersonDAO;
  <span class="hljs-keyword">constructor</span>(<span class="hljs-params"> @Inject personDAO: PersonDAO </span>) {
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-meta">@Scoped</span>(<span class="hljs-keyword">new</span> MyScope()) 
<span class="hljs-keyword">class</span> PersonService {
  <span class="hljs-meta">@Inject</span>
  <span class="hljs-keyword">private</span> personDAO: PersonDAO;
}
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-meta">@Scoped</span>(<span class="hljs-keyword">new</span> MyScope()) 
<span class="hljs-meta">@Provided</span>(personProvider)
<span class="hljs-keyword">class</span> PersonService {
  <span class="hljs-meta">@Inject</span>
  <span class="hljs-keyword">private</span> personDAO: PersonDAO;
}
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-meta">@Provides</span> (PersonDAO)
<span class="hljs-keyword">class</span> ProgrammerDAO extends PersonDAO {
  <span class="hljs-meta">@Inject</span>
  <span class="hljs-keyword">private</span> programmerRestProxy: PersonRestProxy;
}
...
<span class="hljs-keyword">let</span> p: PersonDAO = <span class="hljs-keyword">new</span> PersonDAO(); <span class="hljs-comment">// Works again.</span>
				...
				<pre><code class="lang-typescript"><span class="hljs-keyword">interface</span> PersonDAO {
  <span class="hljs-keyword">get</span>(id: <span class="hljs-built_in">string</span>): Person;
}

<span class="hljs-meta">@AutoWired</span>
<span class="hljs-meta">@Provides</span> (PersonDAO) <span class="hljs-comment">// NOT SUPPORTED</span>
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-keyword">class</span> PersonService {
  <span class="hljs-meta">@Inject</span> <span class="hljs-comment">// NOT SUPPORTED</span>
  <span class="hljs-keyword">private</span> personDAO: PersonDAO;
}
</code></pre>
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-meta">@Provides</span> (PersonDAO) <span class="hljs-comment">// It works</span>
<span class="hljs-keyword">class</span> ProgrammerDAO <span class="hljs-keyword">implements</span> PersonDAO {
  <span class="hljs-meta">@Inject</span>
  <span class="hljs-keyword">private</span> programmerRestProxy: PersonRestProxy;
...
<span class="hljs-meta">@AutoWired</span>
<span class="hljs-keyword">class</span> PersonService {
  <span class="hljs-meta">@Inject</span> <span class="hljs-comment">// It works</span>
  <span class="hljs-keyword">private</span> personDAO: PersonDAO;
}
</code></pre>
